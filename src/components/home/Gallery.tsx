...
const GALLERY = [
  ...
  {
    src: "/images/work-crowd-toast.jpg",
    alt: "Singer raised on the crowd's shoulders, glass held high, a sea of arms raised beneath red stage light and bunting",
    cap: "02 — He toasted, the room roared back",
