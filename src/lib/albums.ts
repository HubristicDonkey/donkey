...
export const ALBUMS: Album[] = [
  {
    ...
    blurb:
      "A late set at O'Shea's — sports bar by day, low-lit music room by night. Two performers, one mic stand, and a crowd that never once stopped moving.",
    cover: "/images/albums/lbts-osheas/13.jpg",
    photos: [
      {
      ...
      },
      {
        ...
        alt: "Guitarist in profile playing an acoustic guitar under blue stage light",
        caption: "Every chord held a beat longer than it needed to.",
        tag: "Portrait",
      },
      {
        src: "/images/albums/lbts-osheas/03.jpg",
        alt: "Singer and guitarist laughing together mid-set",
        caption: "Whatever the joke was, the room never heard it.",
      ...
      },
      {
        ...
        alt: "A second musician in profile, glasses catching the stage light",
        caption: "New voice, same low light.",
        tag: "Live music",
      },
      {
      ...
      },
      {
        ...
        alt: "Singer and guitarist facing each other in profile, O'Shea's sign glowing behind them",
        caption: "Two profiles, one song.",
        tag: "Live music",
      },
      {
        src: "/images/albums/lbts-osheas/08.jpg",
        alt: "Extreme close profile of the singer mid-note, teal stage light",
        caption: "Close enough to hear the breath before the word.",
        tag: "Portrait",
      },
      {
      ...
      {
        src: "/images/albums/lbts-osheas/11.jpg",
        alt: "Long exposure black and white blur of the singer turning, LIVE MUSIC sign visible above",
        caption: "The shutter stayed open longer than she stood still.",
        tag: "Long exposure",
      },
      {
        src: "/images/albums/lbts-osheas/12.jpg",
      ...
      {
        src: "/images/albums/lbts-osheas/13.jpg",
        alt: "Singer with both arms raised in triumph, full O'Shea's sign lit behind her",
        caption: "Last note, arms up, sign still burning.",
        tag: "Live music",
      },
    ],
  },
  ...
  },
  {
    ...
    title: "Kenny and Bra vs Mor — A Night at O'Shea's",
    blurb:
